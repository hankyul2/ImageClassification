...
def get_log_name(args, log_format='{}/{}'):
    return log_format.format(args.model_name, args.dataset)
    ...
    def update_best_result(self):
        ...
        for model_name in set(result_dict[self.best_result_identity_name]):
            ...
            for identity_column in self.get_identity_columns(result_list, model_name):
                ...
                best_result.append(self.filter_best_result(target_data, num=3 if len(target_data) > 3 else len(target_data)))
